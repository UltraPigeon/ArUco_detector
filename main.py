...
def main():
    ...
    total_level_width = len(level.level_map[0]) * classes.wall_width  # Высчитываем фактическую ширину уровня
    total_level_height = len(level.level_map) * classes.wall_length  # высоту
